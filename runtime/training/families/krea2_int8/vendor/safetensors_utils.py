"""Copied verbatim from kohya-ss/musubi-tuner (Apache-2.0); only the import of
``device_utils`` is rewired to the local vendored package.

Copyright 2026 Kohya S. and musubi-tuner contributors.
Source: musubi_tuner/utils/safetensors_utils.py (pinned revision, see THIRD_PARTY_NOTICES).
"""
...
from training.families.krea2_int8.vendor.device_utils import synchronize_device
