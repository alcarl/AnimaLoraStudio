...
Copied from kohya-ss/musubi-tuner (Apache-2.0); only the imports are rewired to the
local vendored package. Copyright 2026 Kohya S. and musubi-tuner contributors.
Source: musubi_tuner/modules/convrot_int8_utils.py (pinned revision, see THIRD_PARTY_NOTICES).
...
from training.families.krea2_int8.vendor.safetensors_utils import MemoryEfficientSafeOpen, TensorWeightAdapter, WeightTransformHooks
from training.families.krea2_int8.vendor.device_utils import clean_memory_on_device
